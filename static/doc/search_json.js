window.ydoc_plugin_search_json = {
  "教程": [
    ...
    },
    {
      ...
      "children": [
        ...
        },
        {
          ...
          "content": "初始化目录可参考 项目vendors/exts 目录下的插件在 vendors/node_modules 下新建 yapi-plugin-demo 目录和 npm init,最后生成的目录结构如下yapi-plugin-demo  client.js  //客户端入口文件\n  server.js  //服务端入口文件\n  packjson.json //插件依赖管理\n  index.js //插件配置文件\n"
        },
        {
          "title": "index.js 配置说明",
    ...
    },
    {
      ...
      "children": [
        {
          "title": "1.10.2 (2021-10-13)",
          "url": "\\documents\\CHANGELOG.html#1.10.2-2021-10-13",
          "content": "1.10.2 (2021-10-13)"
        },
        {
          "title": "Bug Fixes",
          "url": "\\documents\\CHANGELOG.html#1.10.2-2021-10-13-bug-fixes",
          "content": "Bug Fixes[2361] 修复所有分类被删除时,同步问题. 解决方案: 增加 \"默认分类\" (01207e2)\nissues 2357 (5bab76c)\n"
        },
        {
          "title": "Features",
          "url": "\\documents\\CHANGELOG.html#1.10.2-2021-10-13-features",
          "content": "Featuresadd nonexistent tags from /interface/(add/up/save) (#1918) (4d24c39)\n"
        },
        {
          "title": "1.10.1",
          "url": "\\documents\\CHANGELOG.html#1.10.1",
          "content": "1.10.1"
        },
        {
          "title": "Bug Fixes",
          "url": "\\documents\\CHANGELOG.html#1.10.1-bug-fixes",
          "content": "Bug Fixes修复沙盒漏洞\n"
        },
        {
          "title": "v1.9.2",
          "url": "\\documents\\CHANGELOG.html#v1.9.2",
          "content": "v1.9.2fix: 修复高级 mock 无效的bug\nopti: 对登录 email 空格的过滤\nfix: 修复deepMath 增加对原型属性比较\n"
        },
        {
          "title": "v1.9.1",
          "url": "\\documents\\CHANGELOG.html#v1.9.1",
          "content": "v1.9.1修复因 mongodb 一个废弃报错导致部署不成功问题\n"
        },
        {
          "title": "v1.9.0",
          "url": "\\documents\\CHANGELOG.html#v1.9.0",
          "content": "v1.9.0修复测试集合部分情况下闪动问题\n修改ldap filter的匹配规则，使其可以匹配&和|操作符  Merge pull request #1631 from vvkkhjt/master\nsupport switch_notice for /interface/save  Merge pull request #1646 from tangcent/feature/openapi_notice\n自动化测试时服务端测试node默认2分钟没有返回就直接断掉连接，可以手动设置一个超时时间 Merge pull request #1675 from liugddx/master\n修复导出的swagger.json 中 required 一直是 false 的 bug\n修复 schema2json传required参数时，导致faker失败\n修改ldap filter的匹配规则\n更新 sm2tsservice 3.2.0及以后版本的使用配置\n"
        },
        {
          "title": "v1.8.8",
          "url": "\\documents\\CHANGELOG.html#v1.8.8",
          "content": "v1.8.8更新了 cross-request 教程，发布了最新的 3.1 版本\n"
        },
        {
          "title": "v1.8.7",
          "url": "\\documents\\CHANGELOG.html#v1.8.7",
          "content": "v1.8.7因 chrome 官方下架了 yapi 扩展，整理了本地安装教程\n"
        },
        {
          "title": "v1.8.6",
          "url": "\\documents\\CHANGELOG.html#v1.8.6",
          "content": "v1.8.6优化 swagger 文档导入分类策略，优先使用根路径的 tags 做分类，避免出现特别多分类的问题\n"
        },
        {
          "title": "v1.8.5",
          "url": "\\documents\\CHANGELOG.html#v1.8.5",
          "content": "v1.8.5改善 swagger 自动导入，不再支持秒级别的 cron 表达式,默认使用 10分钟更新一次的频率\n修复输入空的 swagger地址 ，会发起请求的 bug\n优化 swagger 数据导入，不会导入空的分类，不会使用版本号作为分类名称\nswagger 导入自动增加 basePath 到项目配置\n"
        },
        {
          "title": "v1.8.4",
          "url": "\\documents\\CHANGELOG.html#v1.8.4",
          "content": "v1.8.4修复 swagger 导入数据时，如果数据格式中缺少 in 的参数，会丢失请求参数\n修复当传入数据格式的 method 不规范时，容易导致获取对象为空，出现异常导致动态页面无法打开\n修复解决 json-schema-faker/json-schema-faker#453 问题\n"
        },
        {
          "title": "v1.8.3",
          "url": "\\documents\\CHANGELOG.html#v1.8.3",
          "content": "v1.8.3修复管理员无法看到所有分组的 bug\n"
        },
        {
          "title": "v1.8.2",
          "url": "\\documents\\CHANGELOG.html#v1.8.2",
          "content": "v1.8.2重构分组列表功能实现，大幅度优化首屏加载速度\n接口运行界面设置 header、query、form 的初始值为其示例值\n运行接口请求时支持自动预览HTML\n"
        },
        {
          "title": "v1.8.1",
          "url": "\\documents\\CHANGELOG.html#v1.8.2-v1.8.1",
          "content": "v1.8.1优化插件【Swagger 自动同步】在添加地址时的服务端校验行为\n优化单个测试用例执行超时时间限制,从3秒改为10秒\n"
        },
        {
          "title": "v1.8.0",
          "url": "\\documents\\CHANGELOG.html#v1.8.2-v1.8.0",
          "content": "v1.8.0filtering interface on the server instead of client\n"
        },
        {
          "title": "v1.7.2",
          "url": "\\documents\\CHANGELOG.html#v1.8.2-v1.7.2",
          "content": "v1.7.2支持接口路径模糊搜索，不包含 basepath\n"
        },
        {
          "title": "v1.7.1",
          "url": "\\documents\\CHANGELOG.html#v1.8.2-v1.7.1",
          "content": "v1.7.1废弃 yapi.ymfe.org 文档站点\n"
        },
        {
          "title": "v1.7.0",
          "url": "\\documents\\CHANGELOG.html#v1.8.2-v1.7.0",
          "content": "v1.7.0fix：修复md两个undefined以及run_auto_test中执行用例id问题 #1024\n"
        },
        {
          "title": "v1.7.0-beta.1",
          "url": "\\documents\\CHANGELOG.html#v1.8.2-v1.7.0-beta.1",
          "content": "v1.7.0-beta.1修复storage保存逻辑错误\n"
        },
        {
          "title": "v1.7.0-beta.0",
          "url": "\\documents\\CHANGELOG.html#v1.8.2-v1.7.0-beta.0",
          "content": "v1.7.0-beta.0[插件] 新增默认插件，支持通过 token 导出包含 basepath 的 json 格式接口，并整合添加 sm2tsservice 入口\n[插件] 新增默认插件，支持swagger数据同步\n修复不兼容 node7.6 bug\n"
        },
        {
          "title": "v1.5.14",
          "url": "\\documents\\CHANGELOG.html#v1.8.2-v1.5.14",
          "content": "v1.5.14修复接口运行部分请求参数默认使用示例填写值导致无法删除参数bug\n修复无法保存 global bug\n"
        },
        {
          "title": "v1.5.13 （存在bug）",
          "url": "\\documents\\CHANGELOG.html#v1.8.2-v1.5.13-（存在bug）",
        ...
        {
          "title": "v1.4.1",
          "url": "\\documents\\CHANGELOG.html#v1.8.2-v1.4.1",
        ...
        {
          "title": "v1.3.23",
          "url": "\\documents\\CHANGELOG.html#v1.8.2-v1.3.23",
        ...
        {
          "title": "v1.3.17",
          "url": "\\documents\\CHANGELOG.html#v1.8.2-v1.3.17",
        ...
        {
          "title": "v1.3.4",
          "url": "\\documents\\CHANGELOG.html#v1.8.2-v1.3.4",
        ...
        {
          "title": "v1.3.3",
          "url": "\\documents\\CHANGELOG.html#v1.8.2-v1.3.3",
        ...
        {
          "title": "v1.2.6",
          "url": "\\documents\\CHANGELOG.html#v1.8.2-v1.2.6",
        ...
        {
          "title": "v1.2.5",
          "url": "\\documents\\CHANGELOG.html#v1.8.2-v1.2.5",
        ...
        {
          "title": "v1.2.4",
          "url": "\\documents\\CHANGELOG.html#v1.8.2-v1.2.4",
        ...
        {
          "title": "v1.2.0",
          "url": "\\documents\\CHANGELOG.html#v1.8.2-v1.2.0",
        ...
        {
          "title": "v1.1.2",
          "url": "\\documents\\CHANGELOG.html#v1.8.2-v1.1.2",
        ...
        {
          "title": "v1.1.1",
          "url": "\\documents\\CHANGELOG.html#v1.8.2-v1.1.1",
