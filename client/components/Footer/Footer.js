...
Footer.defaultProps = {
  footList: [
	...
	{
	  itemTitle: 'yapii',
	  itemLink: 'https://github.com/gozeon/yapii'
	},
        {
          itemTitle: 'YApi 源码仓库',
	...
	{
	  itemTitle: 'Goze',
	  itemLink: 'https://github.com/gozeon'
	},
        {
          itemTitle: 'YMFE',
      ...
      linkList: [
        {
          ...
          itemLink: 'https://github.com/gozeon/yapii/issues'
        },
        {
          itemTitle: 'Github Pull Requests',
          itemLink: 'https://github.com/gozeon/yapii/pulls'
        }
      ]
    },
    {
      title: `Copyright © ${new Date().getFullYear()} YMFE`,
      linkList: [
        {
          itemTitle: `版本: ${version} `,
          itemLink: 'https://github.com/gozeon/yapii/blob/master/CHANGELOG.md'
        },
        {
          itemTitle: '使用文档',
